        ...
        <div className="container-max">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="mt-16">
                <h3 className="text-3xl font-bold text-brown-800 mb-8 text-center">우리가 제공하는 특별함</h3>
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="group bg-gradient-to-br from-coffee-100/50 to-coffee-200/30 backdrop-blur-sm rounded-xl p-6 border border-coffee-200/30 hover:shadow-lg hover:scale-105 transition-all duration-300">
                    <div className="w-12 h-12 bg-gradient-to-br from-coffee-500 to-coffee-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                      </svg>
                    </div>
                    <h4 className="font-bold text-brown-800 mb-2 text-lg">스페셜티 커피</h4>
                    <p className="text-brown-600">엄선된 원두를 직접 로스팅하여 최상의 맛을 제공합니다.</p>
                  </div>

                  <div className="group bg-gradient-to-br from-brown-100/50 to-brown-200/30 backdrop-blur-sm rounded-xl p-6 border border-brown-200/30 hover:shadow-lg hover:scale-105 transition-all duration-300">
                    <div className="w-12 h-12 bg-gradient-to-br from-brown-500 to-brown-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                      </svg>
                    </div>
                    <h4 className="font-bold text-brown-800 mb-2 text-lg">원두 납품</h4>
            ...
            <div className="relative">
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-br from-coffee-400/20 to-coffee-600/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
              ...
              <div className="absolute -top-8 -right-8 w-32 h-32 bg-gradient-to-br from-coffee-300/10 to-coffee-500/10 rounded-full blur-2xl animate-pulse"></div>
              <div className="absolute -bottom-8 -left-8 w-24 h-24 bg-gradient-to-br from-brown-300/10 to-brown-500/10 rounded-full blur-xl animate-pulse"></div>
              
              {/* Floating Quote */}
              <div className="absolute top-1/2 -left-12 transform -translate-y-1/2 hidden lg:block">
                <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-white/50 max-w-xs">
                  <div className="text-coffee-600 text-4xl font-serif mb-2">"</div>
                  <p className="text-brown-700 font-medium italic">
                    커피를 통해 사람들과 소통하는 특별한 순간
                  </p>
                  <div className="text-coffee-600 text-4xl font-serif text-right">„</div>
                </div>
              </div>
            </div>
          </div>
